...
def main():
    ...
    a=sp.add_parser('export-webp'); a.add_argument('source'); a.add_argument('destination'); a.add_argument('--width',type=int,default=1000); a.add_argument('--height',type=int,default=1000); a.add_argument('--quality',type=int,default=86); a.add_argument('--fit',choices=['contain','cover','stretch'],default='contain')
    a=sp.add_parser('export-png'); a.add_argument('source'); a.add_argument('destination'); a.add_argument('--width',type=int); a.add_argument('--height',type=int)
    ...
    elif ns.cmd=='export-webp': out=export_webp(ns.source,ns.destination,ns.width,ns.height,ns.quality,ns.fit)
    elif ns.cmd=='export-png': out=export_png(ns.source,ns.destination,ns.width,ns.height)
